...
paredes::paredes(int w_, int h_, int x, int y) //  implementación del constructor de la clase paredes
{
    w = w_;
    h = h_;
    posx = x;
...
QRectF paredes::boundingRect() const //  implementación de boudingRect() para delimitar con un rectangulo
{
